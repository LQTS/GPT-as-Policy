...
description: Control one authorized PTrack Sharpa in-hand object-axis rotation episode directly from RGB and named state, without an RL policy.
---
...
This is a bounded smoke rollout, not a full-horizon success claim. Once it finishes,
